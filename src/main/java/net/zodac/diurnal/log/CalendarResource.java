...
/**
 * Supplies the JSON feeds consumed by the dashboard's calendar (the {@code full} view reads {@code /logs/events}; the {@code minimal}/{@code stacked}
 * dot/bar views read {@code /logs/minimal-events}).
 *
 * <p>
