...
class AppPathsTest {
    ...
    void everyInternalUrl_atRoot_isUnprefixed() {
        ...
        final List<String> expected = List.of(
            ...
            "/internal/note-attachments/list",
            "/internal/note-attachments/list?page=1",
            "/internal/note-attachments/2026-06-15/81d92e7a-6589-4050-984d-98234bcece64/file",
            "/internal/stats/list",
    ...
    private static List<String> internalUrls(final AppPaths paths) {
        return List.of(
            ...
            paths.getInternalNoteAttachmentsList(),
            paths.getInternalNoteAttachmentsListFirstPage(),
            paths.internalNoteAttachmentFile(DATE, DUMMY_UUID),
