...
class OpenApiSurfaceIT extends IntegrationTestBase {
    ...
    private static final Set<String> PUBLIC_API_CONTRACT = Set.of(
        ...
        "GET /api/v1/notes/{date}/attachments",
        "POST /api/v1/notes/{date}/attachments",
        "GET /api/v1/notes/{date}/attachments/{id}",
        "PATCH /api/v1/notes/{date}/attachments/{id}",
        "DELETE /api/v1/notes/{date}/attachments/{id}",
