...
class NaughtyStringsTest {
    ...
    void check_note_keepsTheShapeTheUserWrote() {
        ...
        assertThat(TextValidation.check(TextFields.DEFAULT_NOTE, entry))
    ...
    void check_note_rejectsEveryInvisibleCharacterTheOtherFieldsReject(final String invisible) {
        ...
        assertThat(TextValidation.check(TextFields.DEFAULT_NOTE, "First line\nru" + invisible + "n"))
    ...
    void check_note_foldsTheCarriageReturnsBrowsersSubmit() {
        ...
        assertThat(TextValidation.check(TextFields.DEFAULT_NOTE, "First\r\nSecond"))
    ...
    void check_note_ofOnlyNewlines_normalisesToEmpty() {
        ...
        assertThat(TextValidation.check(TextFields.DEFAULT_NOTE, "\n".repeat(500)))
    ...
    void check_note_countsItsNewlinesTowardTheBound() {
        ...
        assertThat(TextValidation.check(TextFields.DEFAULT_NOTE, twoLines))
