...
class ImportSummaryExtensionsTest {
    ...
    void replacesExistingData_isFalseOnlyWhenTheAccountIsCompletelyEmpty() {
        assertThat(ImportSummaryExtensions.replacesExistingData(new ImportSummary(5, 5, 5, 5, false, 0, 0, 0, 0)))
        ...
        final List<ImportSummary> holdingSomething = List.of(
            new ImportSummary(0, 0, 0, 0, false, 1, 0, 0, 0),
            new ImportSummary(0, 0, 0, 0, false, 0, 1, 0, 0),
            new ImportSummary(0, 0, 0, 0, false, 0, 0, 1, 0),
            new ImportSummary(0, 0, 0, 0, false, 0, 0, 0, 1));
