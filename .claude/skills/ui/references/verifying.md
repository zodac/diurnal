...
- **`documentation`** — the 17 README shots in `docs/screenshots/`. **Also gitignored, and also generated by the
  ...
  standalone `screenshots` GitHub release, which the README and `docs/dockerhub-overview.md` embed by absolute
  ...
  refresh the published set between releases: `gh release upload screenshots --clobber docs/screenshots/*.webp`.
