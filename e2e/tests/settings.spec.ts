...
// flakiness).
async function waitForSave(page: { waitForResponse: (arg0: (r: any) => boolean) => any; }, action: Promise<unknown>) {
    await Promise.all([
...
async function selectTile(page: Page, name: string, value: string) {
