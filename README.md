...
<p align="center">
  <img src="https://github.com/zodac/diurnal/releases/download/readme-assets/dashboard-system.webp" alt="The Diurnal dashboard in both light and dark themes" width="600">
  &emsp;&emsp;
  <img src="https://github.com/zodac/diurnal/releases/download/readme-assets/dashboard-mobile.webp" alt="The Diurnal dashboard on a phone, in both light and dark themes" width="170">
</p>
...
<img src="https://github.com/zodac/diurnal/releases/download/readme-assets/actions-dark.webp" alt="The Actions page, listing tracked habits" width="600">
...
<p align="center">
  <img src="https://github.com/zodac/diurnal/releases/download/readme-assets/note-box-dark.webp" alt="The note box on the dashboard, holding a written note" width="420">
</p>
<!-- markdownlint-enable MD013 MD033 -->
...
<img src="https://github.com/zodac/diurnal/releases/download/readme-assets/stats-notes-dark.webp" alt="The Notes card on the Stats page, showing streaks, gaps and totals" width="320">
<!-- markdownlint-enable MD013 MD033 -->
...
|:-----------------------------------------------------------------------------------------------------------------------------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------:|
| <img src="https://github.com/zodac/diurnal/releases/download/readme-assets/cal-full-dark.webp" alt="The full calendar style" width="280"> | <img src="https://github.com/zodac/diurnal/releases/download/readme-assets/cal-minimal-dark.webp" alt="The minimal calendar style" width="280"> | <img src="https://github.com/zodac/diurnal/releases/download/readme-assets/cal-stacked-dark.webp" alt="The stacked calendar style" width="280"> |
...
|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| <img src="https://github.com/zodac/diurnal/releases/download/readme-assets/stats-dark.webp" alt="The Stats page, showing per-action statistic tiles" width="400"> | <img src="https://github.com/zodac/diurnal/releases/download/readme-assets/stats-graph-dark.webp" alt="The frequency graph, comparing three actions over one month" width="400"> |
...
|                                                                     Dark                                                                      |                                                                      Light                                                                      |
|:---------------------------------------------------------------------------------------------------------------------------------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------:|
| <img src="https://github.com/zodac/diurnal/releases/download/readme-assets/dashboard-dark.webp" alt="The dashboard in dark mode" width="400"> | <img src="https://github.com/zodac/diurnal/releases/download/readme-assets/dashboard-light.webp" alt="The dashboard in light mode" width="400"> |
...
|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| <img src="https://github.com/zodac/diurnal/releases/download/readme-assets/language-dropdown-dark.webp" alt="The Settings language picker, open, showing the offered languages by their own name" height="256"> | <img src="https://github.com/zodac/diurnal/releases/download/readme-assets/dashboard-arabic-dark.webp" alt="The dashboard shown in Arabic, mirrored right-to-left" width="400"> |
...
<img src="https://github.com/zodac/diurnal/releases/download/readme-assets/login-dark.webp" alt="The Diurnal login page" width="600">
...
<img src="https://github.com/zodac/diurnal/releases/download/readme-assets/settings-dark.webp" alt="The Settings page" width="600">
...
<img src="https://github.com/zodac/diurnal/releases/download/readme-assets/admin-dark.webp" alt="The admin user-management page" width="600">
